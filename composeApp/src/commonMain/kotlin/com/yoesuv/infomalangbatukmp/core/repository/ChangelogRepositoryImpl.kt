...
import infomalangbatukmp.composeapp.generated.resources.changelog_desc_1_0_2
...
import infomalangbatukmp.composeapp.generated.resources.changelog_version_1_0_2

class ChangelogRepositoryImpl : ChangelogRepository {
    override fun getChangelogResources(): List<ChangeLogResource> {
        return listOf(
            ChangeLogResource(
                versionRes = Res.string.changelog_version_1_0_2,
                descriptionRes = Res.string.changelog_desc_1_0_2
            ),
            ChangeLogResource(
